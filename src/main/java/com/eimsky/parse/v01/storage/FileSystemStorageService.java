...
import com.eimsky.parse.v01.exceptions.StorageException;
...
public class FileSystemStorageService implements StorageService {
	...
	public FileSystemStorageService (StorageProperties properties, CSVParserService csvParserService) {
	...
	public String store(MultipartFile file) {
		try {
			...
			try (InputStream inputStream = file.getInputStream()) {
				...
				System.out.println("File stored at: " + destinationFile.toString());
